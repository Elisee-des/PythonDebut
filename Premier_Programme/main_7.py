...
def afficher_information_personne(nom_utlisateur, age_utilisateur, taille=0):
    ...
    if age_utilisateur == 1 or age_utilisateur == 2:
        print("Vous vrmnt un gros bb.")
